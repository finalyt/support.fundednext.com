...
function sb_ajax_execute() {
    switch ($_POST['function']) {
        ...
        case 'csv-users':
            return sb_json_response(sb_csv_users());
        ...
        case 'reports':
            return sb_json_response(sb_reports($_POST['name'], sb_post('date_start'), sb_post('date_end')));
        case 'reports-update':
